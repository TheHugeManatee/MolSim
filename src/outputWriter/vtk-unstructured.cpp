...
: ::DataArrayList_t (),
  ...
  NumberOfComponents_ (NumberOfComponents, ::xml_schema::flags (), this),
  format_ (format_default_value (), ::xml_schema::flags (), this),
...
: ::xml_schema::type (),
  PointData_ (PointData, ::xml_schema::flags (), this),
  CellData_ (CellData, ::xml_schema::flags (), this),
  Points_ (Points, ::xml_schema::flags (), this),
  Cells_ (Cells, ::xml_schema::flags (), this),
  NumberOfPoints_ (NumberOfPoints, ::xml_schema::flags (), this),
  NumberOfCells_ (NumberOfCells, ::xml_schema::flags (), this)
{
}
...
: ::xml_schema::type (),
  Piece_ (Piece, ::xml_schema::flags (), this)
{
}
...
: ::xml_schema::type (),
  ...
  PolyData_ (::xml_schema::flags (), this),
  type_ (type, ::xml_schema::flags (), this),
       ...
       ::xml_schema::flags f)
{
  for (; p.more_elements (); p.next_element ())
  {
    ...
    {
      ::std::auto_ptr< PolyData_type > r (
        PolyData_traits::create (i, f, this));

      if (!this->PolyData_)
      {
        this->PolyData_.set (r);
        continue;
      }
    }
...
PointData ()
: ::xml_schema::type (),
  DataArray_ (::xml_schema::flags (), this)
{
}
